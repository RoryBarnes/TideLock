...
# spin periods of 8 hr, initial obliquities of 60 degrees, and adhere to the
# CPL model.
#
...
dm=0.01	        # Increment in stellar mass in solar units

amin=0.05	# Minimum semi-major axis in AU
amax=1.3	# Maximum semi-major axis in AU
da=0.001	# Increment in semi-major axis in AU

# Planetary properties
plper=0.33333	# Initial planetary rotation period in days
plobl=60	# Initial planetary obliquity in degrees
...
xlim=[0,1.25]     # x-axis limits for plot
